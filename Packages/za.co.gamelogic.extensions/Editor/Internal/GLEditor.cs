...
namespace Gamelogic.Extensions.Editor.Internal
{
	...
	{
		/// <summary>Gets the inspected target cast to type <typeparamref name="T"/>.</summary>
		public T Target => (T)target;

		/// <summary>Gets all inspected targets cast to type <typeparamref name="T"/>.</summary>
		...
		/// <summary>Draws a popup dropdown and returns the selected index.</summary>
		/// <param name="options">The options to display in the popup.</param>
		...
		/// <summary>Returns whether the target object has a serialized property with the given name.</summary>
		...
		/// <summary>Finds a serialized property by name and wraps it in a <see cref="GLSerializedProperty"/>.</summary>
		/// <param name="propertyName">The name of the serialized property to find.</param>
		/// <returns>A <see cref="GLSerializedProperty"/> wrapping the found property.</returns>
		...
		/// <summary>Draws a property field for the given serialized property.</summary>
		...
		/// <summary>Draws a property field for the given <see cref="GLSerializedProperty"/>, using its custom tooltip.</summary>
		/// <param name="prop">The property to draw.</param>
		...
		/// <summary>Draws a label field with a title and a text value.</summary>
		/// <param name="title">The label title.</param>
		/// <param name="text">The label text value.</param>
		protected void AddLabel(string title, string text)
		{
			EditorGUILayout.LabelField(title, text);
		}

		/// <summary>Draws a bold label next to a button; invokes <paramref name="buttonAction"/> when the button is clicked.</summary>
		/// <param name="text">The text to display as a bold label.</param>
		/// <param name="buttonLabel">The label of the button.</param>
		/// <param name="buttonAction">The action to invoke when the button is clicked.</param>
		...
		/// <summary>Draws an inspector GUI for an array serialized property, allowing resizing and element editing.</summary>
		/// <param name="obj">The serialized object owning the property.</param>
		/// <param name="property">The array property to draw.</param>
