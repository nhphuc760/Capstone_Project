...
namespace Gamelogic.Extensions.Editor
{
	...
	public abstract class PopupListPropertyDrawer<T> : PropertyDrawer
	{
		...
		/// <summary>The cached list of values to display in the popup.</summary>
		protected T[] values;
		...
		/// </summary>
		/// <returns>An array of values to display.</returns>
		/// <exception cref="NotImplementedException">Always thrown by the base implementation; override in a derived class.</exception>
		/// <remarks>
