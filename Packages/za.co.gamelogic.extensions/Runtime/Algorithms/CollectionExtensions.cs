...
{
	/// <summary>
	/// Provides useful extension methods for collections, mostly <see cref="IEnumerable{T}"/>.
	/// </summary>
	[Version(1, 0, 0)]
	public static class CollectionExtensions
	{
		...
		/// <summary>
		/// Returns all elements of the source which are of type <typeparamref name="TFilter"/>.
		/// </summary>
		/// <typeparam name="T">The type of elements in the source.</typeparam>
		/// <typeparam name="TFilter">The type to filter by. Must be a subtype of <typeparamref name="T"/>.</typeparam>
		/// <param name="source">The source collection to filter.</param>
		/// <returns>An enumerable containing only elements that are of type <typeparamref name="TFilter"/>.</returns>
		...
		/// <summary>
		/// Adds all elements of <paramref name="other"/> to the given collection.
		/// </summary>
		/// <typeparam name="T">The type of elements in the collection.</typeparam>
		/// <param name="collection">The collection to add elements to.</param>
		/// <param name="other">The elements to add. If <see langword="null"/>, nothing is added.</param>
		...
		/// <summary>
		/// Returns a pretty string representation of the given list. The resulting string looks something like <c>[a, b, c]</c>.
		/// </summary>
		/// <typeparam name="T">The type of elements in the source.</typeparam>
		/// <param name="source">The source to convert to a string. If <see langword="null"/>, returns the string <c>"null"</c>.</param>
		...
		/// </summary>
		/// <typeparam name="T">The type of elements in the source.</typeparam>
		/// <param name="source">The source to skip the first element of.</param>
		/// <returns>All elements of <paramref name="source"/> except the first.</returns>
		...
		/// </summary>
		/// <typeparam name="T">The type of elements in the source.</typeparam>
		/// <param name="source">The source to skip the last element of.</param>
		/// <returns>All elements of <paramref name="source"/> except the last.</returns>
		...
		/// <param name="source">The source to find the minimum in.</param>
		/// <param name="selector">A function to extract a comparable key from each element.</param>
		/// <returns>The element with the smallest key.</returns>
		...
		/// <typeparam name="TSource">The type of elements in the source.</typeparam>
		/// <typeparam name="TKey">The type of the key used to compare elements.</typeparam>
		/// <param name="source">The source to find the maximum in.</param>
		/// <param name="selector">A function to extract a comparable key from each element.</param>
		/// <returns>The element with the largest key.</returns>
		/// <exception cref="InvalidOperationException">The sequence is empty.</exception>
		...
		/// <typeparam name="T">The type of elements in the source.</typeparam>
		/// <returns><see langword="true"/> if any element satisfies the predicate; <see langword="false"/> otherwise.</returns>
		[Version(3, 0, 0)]
		...
		/// cast, otherwise it is converted to an <see cref="IReadOnlyCollection{T}"/>. The resulting collection is
		/// enumerated multiple times, so if you want to avoid this, enumerate the collection to something else.
		/// </remarks>
		[Version(3, 0, 0)]
