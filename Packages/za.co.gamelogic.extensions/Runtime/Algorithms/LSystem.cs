...
namespace Gamelogic.Extensions.Algorithms
{
	...
	/// </summary>
	/// <typeparam name="TSymbol">The type used as the alphabet symbols. Must support equality comparison;
	/// if the default equality is not suitable, provide an <see cref="IEqualityComparer{TSymbol}"/> via the constructor.</typeparam>
	[Version(1, 4, 1)]
	public class LSystem <TSymbol>
	{
		...
		/// </summary>
		/// <param name="symbol">The symbol to match. If a rule for this symbol already exists, it is replaced.</param>
		/// <param name="replacement">The sequence of symbols that replaces <paramref name="symbol"/> during rewriting.</param>
