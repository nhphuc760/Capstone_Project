...
namespace Gamelogic.Extensions.Algorithms
{
	...
	*/
	...
	public sealed class RandomAccessPriorityQueue<TElement, TPriority> 
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="RandomAccessPriorityQueue{TElement,TPriority}"/> class with a specified capacity and
		/// comparer.
		/// </summary>
		/// <param name="capacity">The maximum number of elements the priority queue can hold.</param>
		/// <param name="comparer">The comparer used to determine the priority of elements.</param>
