...
namespace Gamelogic.Extensions.Algorithms
{
	...
	/// </summary>
	/// <typeparam name="T">The type of the output of the curve. This type should be interpolatable, so
	/// it is typically a continuous type such as <see cref="float"/>, <see cref="Vector3"/>, or <see cref="Color"/>.</typeparam>
