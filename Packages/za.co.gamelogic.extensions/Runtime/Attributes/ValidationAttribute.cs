...
namespace Gamelogic.Extensions
{
	...
	public abstract class ValidationAttribute : PropertyAttribute
	{
		...
		/// <summary>
		/// Gets and sets the message to display in the inspector or console when the value is invalid.
		/// </summary>
		/// <remarks>
		...
		///
		/// This method is only available in the editor, and therefore subclasses should shield their implementations
		/// accordingly.
		/// </remarks>
