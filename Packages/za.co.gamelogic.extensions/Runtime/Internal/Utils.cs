...
namespace Gamelogic.Extensions.Internal
{
	...
	public static class Utils
	{
		...
		/// <summary>A default red color from the palette.</summary>
		public static readonly Color Red = DefaultColors[7];

		/// <summary>A default yellow color from the palette.</summary>
		public static readonly Color Yellow = DefaultColors[6];

		/// <summary>A default green color from the palette.</summary>
		public static readonly Color Green = DefaultColors[5];

		/// <summary>A default blue color from the palette.</summary>
