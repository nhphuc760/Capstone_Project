...
namespace Gamelogic.Extensions
{
	...
	public class HashPool<T> : IPool<T>
	{
		...
		/// <summary>Initializes a new instance of <see cref="HashPool{T}"/> with the given capacity and callbacks.</summary>
		...
		/// <param name="comparer">An optional equality comparer for the pooled objects.</param>
		public HashPool(
			int initialCapacity,
