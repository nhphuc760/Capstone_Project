...
namespace Gamelogic.Extensions
{
	...
	*/
		...
		where T : class
	{
		...
		/// when it is created for the first time. If your objects accumulate references to other objects while
		/// active, and those references cannot be re-used, remove them in this action so that those objects do not
		/// hog memory while inactive.</param>
