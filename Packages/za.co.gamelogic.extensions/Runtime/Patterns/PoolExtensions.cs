...
{
	/// <summary>Represents a pooled object wrapper that exposes the underlying value and its active state.</summary>
	/// <typeparam name="T">The type of the pooled object.</typeparam>
	public interface IPoolObject<out T>
	{
		/// <summary>Gets the underlying pooled value.</summary>
		T Value { get; }
		...
		*/
		/// <summary>Gets a value indicating whether this pool object is currently active.</summary>
		bool IsActive { get; }
	}

	/// <summary>Provides extension methods for <see cref="IPool{T}"/>.</summary>
	public static class PoolExtensions
	{
		...
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="newCapacity"/> is negative.</exception>
		...
		/// <param name="deactivateFirst">Whether to deactivate objects before destroying them.</param>
		/// <typeparam name="T">The type of the objects in the pool.</typeparam>
