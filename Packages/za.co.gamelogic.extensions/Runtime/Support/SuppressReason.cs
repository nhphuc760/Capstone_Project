...
{
	/// <summary>Provides string constants used to justify suppressions of code analysis warnings.</summary>
	[Version(4, 3, 0)]
	public class SuppressReason
	{
		...
		/// </summary>
		public const string IntentionalFloatingPointComparison = "Intentional floating point comparison.";
