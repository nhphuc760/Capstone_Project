...
namespace Gamelogic.Extensions
{
	...
	public static class ColorExtensions
	{
		...
		/// <summary>The hexadecimal string representation of black.</summary>
		...
		/// <returns>A new color with each RGB channel increased by a fixed offset.</returns>
		...
		/// </summary>
		/// <param name="color">The base color.</param>
		/// <returns>A new color with each RGB channel decreased by a fixed offset.</returns>
		...
		/// defined as the average of the three color channels.
		/// </summary>
		/// <param name="color">The color to measure.</param>
		/// <returns>The average of the R, G, and B channels.</returns>
		...
		/// <param name="brightness">The target brightness value.</param>
		/// <returns>A new color scaled to the given brightness.</returns>
		...
		/// <returns><see langword="true"/> if the sum of RGB channels is at or below epsilon; otherwise, <see langword="false"/>.</returns>
		...
		/// </summary>
		/// <param name="color">The color to test.</param>
		/// <returns><see langword="true"/> if the sum of RGB channels is at or above (1 - epsilon); otherwise, <see langword="false"/>.</returns>
		...
		/// </summary>
		/// <param name="color">The color to make opaque.</param>
		/// <returns>The color with alpha set to 1.</returns>
		...
		/// <returns>A new color with each RGB channel replaced by (1 - channel), preserving alpha.</returns>
