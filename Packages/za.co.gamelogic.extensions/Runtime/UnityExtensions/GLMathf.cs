...
namespace Gamelogic.Extensions
{
	...
	public static class GLMathf 
	{
		...
		/// </code>
		/// </example>
		/// <param name="v1">The first value in [0, 1).</param>
		/// <param name="v2">The second value in [0, 1).</param>
		/// <param name="t">The interpolation factor.</param>
		/// <returns>The wrapped linear interpolation between <paramref name="v1"/> and <paramref name="v2"/>.</returns>
		...
		/// <returns>The floor modulus of <paramref name="m"/> and <paramref name="n"/>.</returns>
		[Version(2, 2, 0)]
		...
		/// <param name="m">The dividend.</param>
		/// <param name="n">The divisor.</param>
		/// <returns>The floor of the division of <paramref name="m"/> by <paramref name="n"/>.</returns>
		[Version(2, 2, 0)]
		...
		/// Returns the sign function evaluated at the given value.
		/// </summary>
		/// <param name="p">The value to evaluate.</param>
		/// <returns>1 if the given value is positive, -1 if it is negative, and 0 if it is 0.</returns>
