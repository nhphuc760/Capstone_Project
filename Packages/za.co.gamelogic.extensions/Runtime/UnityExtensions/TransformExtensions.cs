...
{
	/// <summary>
	/// Contains useful extension methods for <see cref="Transform"/>.
	/// </summary>
	[Version(1, 0, 0)]
	public static class TransformExtensions
	{
		...
		/// <summary>Destroys all child GameObjects of this transform using <see cref="Object.Destroy"/>.</summary>
	public static void DestroyChildren(this Transform transform)
		...
		/// <summary>Destroys all child GameObjects of this transform immediately using <see cref="Object.DestroyImmediate"/>.</summary>
	/// <remarks>Prefer <see cref="DestroyChildren"/> during play mode; use this in editor scripts.</remarks>
	public static void DestroyChildrenImmediate(this Transform transform)
		...
		/// <summary>
	/// Destroys all child GameObjects using <see cref="DestroyChildren"/> in play mode or <see cref="DestroyChildrenImmediate"/> in edit mode.
	/// </summary>
	public static void DestroyChildrenUniversal(this Transform transform)
		...
		/// <summary>Returns a list of all direct children of this transform.</summary>
	/// <returns>A list containing all direct child transforms.</returns>
	public static List<Transform> GetChildren(this Transform transform)
		...
		/// <summary>Sorts the direct children of this transform by the value returned by <paramref name="sortFunction"/>.</summary>
	/// <param name="transform">The transform whose children to sort.</param>
	/// <param name="sortFunction">A function that maps each child transform to a comparable sort key.</param>
	public static void Sort(this Transform transform, Func<Transform, IComparable> sortFunction)
		...
		/// <summary>Sorts the direct children of this transform alphabetically by name.</summary>
	public static void SortAlphabetically(this Transform transform)
		...
		/// <summary>Returns each direct child transform paired with its sibling index.</summary>
	/// <returns>An enumerable of <c>(Transform, int)</c> tuples for each direct child.</returns>
