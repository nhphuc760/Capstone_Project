...
namespace Gamelogic.Extensions
{
	...
	public static class VectorExtensions
	{
		...
		/// <param name="angleInDeg">The angle in degrees.</param>
		/// <param name="axisPosition">The point to rotate around.</param>
		...
		/// <param name="baseVector">The base vector to project onto.</param>
		/// <returns>The projection of <paramref name="vector"/> onto <paramref name="baseVector"/>.</returns>
		...
		/// <param name="baseVector">The base vector to reject from.</param>
		/// <returns>The rejection of <paramref name="vector"/> from <paramref name="baseVector"/>.</returns>
		...
		{
			var direction = baseVector.normalized;
			var magnitude = Vector4.Dot(vector, direction);
		...
		/// Returns the rejection of this vector onto the given base.
		/// </summary>
		/// <remarks>The sum of a vector's projection and rejection on a base is equal to the original vector.</remarks>
		/// <param name="vector">The vector to reject.</param>
		/// <param name="baseVector">The base vector to reject from.</param>
		/// <returns>The rejection of <paramref name="vector"/> from <paramref name="baseVector"/>.</returns>
		...
		/// <summary>
		/// Returns the floor modulus of each component of this vector by the corresponding component of <paramref name="otherVector"/>.
		/// </summary>
		/// <param name="thisVector">The dividend vector.</param>
		/// <param name="otherVector">The divisor vector.</param>
		/// <returns>A new vector where each component is the floor modulus of the corresponding input components.</returns>
		[Version(1, 4, 4)]
