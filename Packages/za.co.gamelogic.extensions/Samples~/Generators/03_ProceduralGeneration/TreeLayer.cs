...
public class TreeLayer : MonoBehaviour
{
	...
	private PineTree treePrefab = null;
	...
	private void ActivateTree(PineTree tree)
	{
	...
	private void DeactivateTree(PineTree tree)
	{
